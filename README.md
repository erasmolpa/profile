...
Erasmo is a Software Engineer with more than 17 years of experience in the Software Industry. 
...
**Domingo Alonso Group, Gran Canaria**
- **Company:** Wizeline. Working for Warner Bros Discovery as contractor
- **Duration:** May 2019 - April 2021
- **Location:** Full Remote
- **Responsibilities:**
    - Responsible for the platform team (8 members), I'm working closely with the CTO, defining the technical strategy and leading cross-cutting efforts
...
- **Achievements:**
    ...
    - Provide Kubernetes as a Service for Product Teams.
    - Provide an Observability Solution based on Cloud Native tools (Prometheus, Fluxdb, Grafana, and Zabbix). All the stack has been deployed in Production using Kubernetes and Helm.
    - Put ASP Core Services in production using Kubernetes and Helm packaging, increasing the deployment frequency and improving the time to market.
    - Provide Puppet and The Foreman to manage the infrastructure, managing around 500 Servers and 1500 Laptops and 200         Workstations (Windows, Linux, and Mac Os Distros).
    - Provide Immutable infrastructure to deploy Environments with Packer and Terraform.
    - Provide IT and product support teams automation tools using Rundeck
    - Leading the Operation Team (4 members). I am a facilitator/mediator between the development and infrastructure departments to get closer to the DevOps work model.
    ...
    - Audit and analyze weak points and process improvements in the company to enhance them under the DevOps principles.
    - Providing product teams with a better development experience by configuring and automating their environments using       Docker, Vagrant, and PowerShell.
    - Containerization of many products based on ASP.NET Core.
    - Providing a PowerShell-based tool to deploy all products into different markets and infrastructure, developing this       tooling under TDD with PowerShell Pester.
    - Providing tooling and automation to deploy and build products, including maintaining tools like Jenkins, SonarQube,       Nexus, and integration with on-premise and cloud infrastructure.
    - Providing the base and mechanism to migrate software and infrastructure to Azure Cloud, liberating several bare-metal     infrastructures.
    - Providing infrastructure on-demand, creating Demo, QA, and Testing environments using Vagrant.
- **Technologies:**
    ...
    - DevOps Tools/Cloud (Jenkins, Azure, Azure DevOps, Vagrant, PowerShell DSC, Docker)
...
- **Location:** Remote, Traveling every 15 days to Saudi Arabian
- **Responsibilities:**
...
## Atos Spain, Tenerife [August 2015 - December 2016]
- **Company:** Atos Spain, Tenerife
- **Duration:** August 2015 - December 2016
- **Location:** Hybrid

As VP Engineering at Atos Excellence Center, I was involved in several projects simultaneously, including projects for the state post company Correos. One of the notable projects was the technological update of the transfer money system, which involved integration with other systems like PayPal and Western Union.

In addition, I acted as Engineering Manager for a team of over 20 engineers, providing motivation, mentoring, and conducting performance reviews.
...
## Capgemini, Valencia [Juny 2014 – August 2015]
...
## Freelance at Mediaresponse Group, Madrid [February 2013 - Juny 2014]

As a Software Engineer, I worked on several projects using different technologies and frameworks. Some of my key responsibilities and achievements include:
...
# Software Developer (Half-Time Freelance)

## Xtremis, Barcelona [November 2013 - January 2014]

I participated in a Post-Election software development project with Xtremis and Scytl for the Ecuador Government. We developed the Logistic module.

Technologies:

- BackEnd: Java, Spring Core, Spring MVC, Spring Security
- Database: Oracle

# Software Developer Java EE / Php

## IT Ikea Spanish Islands [May 2008 - July 2013]
